...
const LimitedCollection = (props: Props) => {
  ...
  return (
    <div className='flex flex-col justify-center items-center'>
       <h2 className='text-[24px] leading-[27px] font-[600] text-[#303030] font-sans tracking-normal text-center mt-[50px] mb-[20px] uppercase'>Shop our Limited Collection</h2>

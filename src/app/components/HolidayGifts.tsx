...
const HolidayGifts = (props: Props) => {
  return (
    <div className='flex flex-col md:flex-row max-w-full my-[10px]'>
<div className="w-full md:w-[33.33%]  relative h-[400px] flex justify-center items-center shadow-sm" data-aos="zoom-in">
...
<div className="w-full md:w-[33.33%]  relative h-[400px] flex justify-center items-center my-[10px] md:mx-[10px] md:my-0 shadow-sm" data-aos="zoom-in">

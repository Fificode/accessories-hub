...
const FollowUs = (props: Props) => {
  ...
  return (
       ...
       <h2 className='text-[24px] leading-[27px] font-[600] text-[#303030] font-sans tracking-normal text-center mt-[50px] mb-[20px] uppercase'>FOLLOW US ON INSTAGRAM</h2>
       <a href="https://www.instagram.com/accessorieshubworld?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" className='font-[600] text-[18px] text-[#303030] font-sans tracking-normal underline underline-offset-4 my-[10px]'>@accessorieshubworld</a>
